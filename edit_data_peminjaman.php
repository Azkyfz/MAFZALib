...
$query=mysqli_query($connect,"select id_peminjaman,id_buku,judul_buku,nama_pemustaka,tanggal_pinjam,tanggal_kembali from peminjaman WHERE id_peminjaman='$id_peminjaman'");
?>
<form action=update_data_peminjaman.php method=POST>
<style>
        body {
    ...
    <table border="0">
        ...
        ?>
            ...
            <tr>
                <td>Nama Pemustaka</td>
                <td><input type=text name=nama_pemustaka value="<?php echo $row['nama_pemustaka']; ?>" /></td>
            </tr>
            <tr>
